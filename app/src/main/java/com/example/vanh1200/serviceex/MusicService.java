    ...
    private PendingIntent getPendingIntent(int pending) {
        switch (pending) {
            ...
            case PENDING_PLAY_PAUSE: {
                ...
                intent1.putExtra(KEY_PENDING, PENDING_PLAY_PAUSE);
                PendingIntent pendingIntent = PendingIntent.getService(this,
                        PENDING_PLAY_PAUSE, intent1, PendingIntent.FLAG_UPDATE_CURRENT);
                return pendingIntent;
            }

            case PENDING_NEXT: {
                Intent intent2 = new Intent(this, MusicService.class);
                intent2.putExtra(KEY_PENDING, PENDING_NEXT);
                PendingIntent pendingIntent = PendingIntent.getService(this,
                        PENDING_NEXT, intent2, PendingIntent.FLAG_UPDATE_CURRENT);
                return pendingIntent;
            }
            default:
                return null;
